...
public class TileEntityRegisterRenderer extends TileEntitySpecialRenderer {
	...
	private static final ResourceLocation texture = new ResourceLocation(ModInfo.ID.toLowerCase(), "textures/entities/ModelRegister.png");
	...
	public void renderTileEntityAt(TileEntity tileentity, double x, double y, double z, float f) {
		...
		TileEntityRegisterEntity myTile = (TileEntityRegisterEntity) tileentity;
